...
#         img_sz = 224
#         self.data = [
#             (0, np.expand_dims(np.random.rand(img_sz, img_sz, 3), 0), Mock(xyxy=np.array([[10 / img_sz, 20 / img_sz, 30 / img_sz, 40 / img_sz]]), class_id=np.array([0]))),
#             (1, np.expand_dims(np.random.rand(img_sz, img_sz, 3), 0), Mock(xyxy=np.array([[50 / img_sz, 60 / img_sz, 70 / img_sz, 80 / img_sz]]), class_id=np.array([1]))),
#         ]
